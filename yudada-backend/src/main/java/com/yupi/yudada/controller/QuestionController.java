...
//        System.out.println("json串为：" + json);
        String realJson = StringEscapeUtils.unescapeJava(json); // Apache Commons Lang
        JSONArray jsonArray = JSONUtil.parseArray(realJson);
//        System.out.println("jsonArray：" + jsonArray);
        List<QuestionContentDTO> questionContentDTOList = JSONUtil.toList(jsonArray, QuestionContentDTO.class);
